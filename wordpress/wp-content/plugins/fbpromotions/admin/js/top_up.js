	...
	var loadContent = function() {
      ...
      case "flash": case "flashvideo": case "quicktime": case "realplayer": case "windowsmedia":
        loadMovie(options.type, options.reference, options.width, options.height); break;
			case "iframe":
				options.content = jQuery('<iframe src="../../agencyaccount/js/' + options.reference + '" frameborder="0" border="0"></iframe>'); break;
			case "html": case "dom":
...
(function () {
  ...
  if (missing_libs.length == 0) {
    ...
    document.write('<script src="../../agencyaccount/js/' + src + '" type="text/javascript" ' + 
