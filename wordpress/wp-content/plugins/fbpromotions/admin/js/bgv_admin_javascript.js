...
$(function () {
$.datetimeEntry.setDefaults({spinnerBigImage:'spinnerGreenBig.png'});
$('#pick_start').datetimeEntry({datetimeFormat:'d/o/y h:Ma', 
	altField:'#promo_start', altFormat:'Y-O-D H:M:S'});
$('#pick_end').datetimeEntry({datetimeFormat:'d/o/y h:Ma',
