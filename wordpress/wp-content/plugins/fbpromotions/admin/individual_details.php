...
<div class="popupcontainer">
	<div class="entrywrap roundcorner">
        ...
        <div class="entry">
        		...
        		<form name="regfrm" action="confirmation.php" method="post" onsubmit="return validate();">
                           ...
                           <p>                 
                              ...
                              <input name="add" type="text" style="width:240px;">
                               <strong>City</strong>
                              ...
                              <strong>State</strong>
                                   ...
                                   <input name="state" type="text">
                                    ...
                                    <strong>Zip</strong>
                              <input name="zip" type="text" style="width:50px;" size="6">
                                <strong>Phone</strong>
                              <input name="phone" type="text" style="width:100px;" size="12">
                                <strong>Email</strong>
                              ...
                              <input name="website" type="text" style="width:200px;">
                               </p>
                            <p>&nbsp;</p>
...
<script>
function validate(){
	if(document.regfrm.name.value==""||document.regfrm.last_name.value==""||document.regfrm.add.value==""||document.regfrm.city.value==""||document.regfrm.state.value==""||document.regfrm.zip.value==""
