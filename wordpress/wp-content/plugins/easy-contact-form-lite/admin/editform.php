...
<?php 
if ((!isset($_POST['merlic_easyform_submit']) AND !isset($_POST['merlic_easyform_update_submit'])) OR (isset($_POST['merlic_easyform_submit']) AND isset($_POST['delete_form']))) {
...
<form method="POST" accept-charset="utf-8" target="_self" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
    ...
    <br/>
    <br/>
    <input class="button-primary" type="submit" name="merlic_easyform_submit" value="<?php _e('Edit Form'); ?>" />
    <p>
        <?php echo $message; ?>
    </p>
</form>
<?php 
	...
	if (isset($_POST['merlic_easyform_update_submit'])) {
...
<form method="POST" accept-charset="utf-8" target="_self" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
	...
	<p>
		...
		<ul>
			<li><?php _e('For <b>dropdown</b>, please enter values separated by comma');?></li>
		</ul>
	</p>
    ...
    <br/>
    <br/>
    <input class="button-primary" type="submit" name="merlic_easyform_update_submit" value="<?php _e('Save Form'); ?>" /><input type="hidden" name="form_id" value="<?php echo $_POST['form_id']; ?>" />
    <p>
        <?php echo $message; ?>
    </p>
</form>
