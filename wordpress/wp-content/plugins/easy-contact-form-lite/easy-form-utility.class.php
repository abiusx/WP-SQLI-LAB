...
class Merlic_EasyForm_Utility {
	...
	public function notification() {
		...
		';
		$sent = self::send_email(array(get_bloginfo('admin_email')=>get_bloginfo('name')), array('contact@wordpress.phpanswer.com'=>'WordPress Plugins'), EASYFORM_PLUGIN_NAME.' Registration', $body);
	}
