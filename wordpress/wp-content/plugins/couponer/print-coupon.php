<?php 
#Fixed for WP-SQLI-LAB, the table prefix was static in the query
...
$ID = $_GET['ID'];
		...
		$sql_get_coupon_id = "SELECT *, DATE_FORMAT(Expires, '%b %e, %Y') as Expires, DATE_FORMAT(Created, '%b %e, %Y') as Created FROM {$wpdb->prefix}couponer WHERE ID='$ID'";
		var_dump($sql_get_coupon_id);
