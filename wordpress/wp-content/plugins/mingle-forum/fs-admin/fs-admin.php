			...
			if (is_dir(SKINDIR)) {
			   if ($dh = opendir(SKINDIR)) {
				...
				echo "<div class='wrap'><h2><img src='$image' />".__("Mingle Forum >> Skin options", "mingleforum")."</h2><br class='clear' /><table class='widefat'>
					<h3><a style='color:blue;' href='http://cartpauj.com/forum/?mingleforumaction=viewforum&f=5.0'>".__("Get More Skins", "mingleforum")."</a></h3>
					<h3><font color='red'>".__("IMPORTANT: As of version 1.0.03 the skins directory has been moved to /wp-content/mingle-forum-skins/", "mingleforum")." - "."<a href='http://cartpauj.com/forum/?mingleforumaction=viewtopic&t=64.0'>".__("Why did you change it?", "mingleforum")."</a></font></h3>
						<thead>
							<tr>
...
<strong>".__("Support Forum:", "mingleforum")."</strong>  <a class='button' href='http://cartpauj.com/forum'>Support Forum</a><br /><br />
<strong>".__("Mingle Forum Skins:","mingleforum")."</strong>  <a class='button' href='http://cartpauj.com/forum/?mingleforumaction=viewforum&f=5.0'>Get More Skins</a>
				</ul>
                </td></tr>
       </table>
			</div>";
