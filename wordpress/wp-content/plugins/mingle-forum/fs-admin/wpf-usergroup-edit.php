...
if(isset($_POST['edit_usergroup_submit'])){
	...
	$name = $mingleforum->get_usergroup_name($_GET['usergroup_id']);
	...
	echo "<table class='form-table'>
			...
			<tr>
				...
				<td><textarea name='edit_usergroup_description' ".ADMIN_ROW_COL.">".$mingleforum->get_usergroup_description($_GET['usergroup_id'])."</textarea></td>
			</tr>
			<tr>
				<th></th>
